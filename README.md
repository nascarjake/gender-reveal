...
The full-screen fashion-game interface is the default and uses the same game
state, WebGL renderer, reveal, and shared clothesline. Add `?ui=v1` to the URL
to open the original editorial interface.
