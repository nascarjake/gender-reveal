...
function downloadShirt() {
  ...
  let file;
  try {
    file = pngFile(`a-little-secret-${shirt.id.slice(0, 8)}.png`);
    const canShareFile =
      usesMobileSaveSheet() &&
    ...
    navigator
      .share({
        title: "My little secret tie-dye shirt",
        text: "Made with love.",
        files: [file],
      })
